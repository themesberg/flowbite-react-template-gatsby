          ...
          <div className="grid w-full grid-cols-1 gap-6 md:grid-cols-2">
            {CARDS.map((card) => (
              <a
                ...
                href={card.url}
                target="_blank"
                className="group cursor-pointer overflow-hidden rounded-xl border border-gray-200 bg-gray-50 outline-offset-2 outline-primary-600 hover:border-primary-600 focus:outline-2 dark:border-gray-700 dark:bg-gray-800 dark:outline-primary-500 dark:hover:border-primary-500"
                rel="noreferrer"
              >
                <div className="flex items-center gap-6 p-4">
                  ...
                  <svg
                    ...
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                    className="size-6 text-gray-500 transition-transform group-hover:translate-x-1 group-hover:text-primary-600 dark:group-hover:text-primary-500"
                  >
                    <path
                      fillRule="evenodd"
                      clipRule="evenodd"
